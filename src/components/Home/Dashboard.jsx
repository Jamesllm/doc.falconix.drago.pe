...
export default function Dashboard() {
  return (
    <div className="text-start grid grid-cols-2 gap-12 mt-6">
      <div className="ml-auto my-auto max-w-lg">
        <h2 className="text-6xl font-bold my-5">Facil uso del DashBoard</h2>
